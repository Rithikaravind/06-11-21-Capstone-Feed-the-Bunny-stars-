...
function setup() 
{
  ...
  star1 = createSprite(50,360,20,20);
  star1.addImage(star_img); 
  star1.scale = 0.02;

  stardisplay = createSprite(50,50,20,50);
  stardisplay.addAnimation('empty', emptystar);
  stardisplay.addAnimation('one', one);
  stardisplay.addAnimation('two', two);
  ...
  bunny = createSprite(225,620,100,100);
  bunny.scale = 0.2;
